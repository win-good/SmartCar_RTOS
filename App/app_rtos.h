 ...
 *                         或 雷达目标在(1.5m,3m] → 减速；【绿灯，不响蜂鸣器】
 *   二级预警(ALERT_LEVEL2)：前超声波<30cm 或 侧/后超声波<20cm
 *                         或 雷达距离≤1.5m(含雷达+视觉共同确认) → 转向避让；
 *                         黄灯；3kHz 50ms 间歇
...
#define ALERT_LEVEL1     1u   /* 一级：前超声波<1m/视觉目标/雷达(1.5,3m]，绿灯静音 */
#define ALERT_LEVEL2     2u   /* 二级：前<30cm 或 侧/后<20cm 或 雷达≤1.5m，黄灯    */
